		      ...
		      <tbody>
		         <tr>
		            <td valign="top" style="font-size:16px; font-family:Arial; font-weight:normal; border-collapse:collapse; vertical-align:top; padding:20px; margin:0; border:1px solid #ebebeb; background:#FFF">
		               <p align="center"><img data-imagetype="External" src="https://i.ibb.co/hMgBtqm/logo.png" width="240" height="50"></p>

		               <br>Olá <b>{{ $user->name }} {{ $user->lastName }}</b>, <br><br>Para acessar, informe o código de verificação abaixo na plataforma. <br><br>
