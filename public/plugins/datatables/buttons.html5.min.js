        ...
        action: function (a, b, d, c) {
            ...
            if (f.queryCommandSupported("copy")) {
                ...
                try {
                    f.execCommand("copy");
                    d.remove();
                    b.buttons.info(b.i18n("buttons.copyTitle", "Copiar para área de transferência"), b.i18n("buttons.copySuccess", { 1: "Copiou uma linha para a área de transferência", _: "Copiou %d linhas para a área de transferência" }, a.rows), 2e3);
                    return;
                } catch (i) {}
            }
        ...
        action: function (a, b, e, c) {
            ...
            e = function (a) {
                for (var b = [], c = 0, d = a.length; c < d; c++) {
                    ...
                    b.push(
                        "number" === typeof a[c] || (a[c].match && a[c].match(/^-?[0-9\.]+$/) && "0" !== a[c].charAt(0))
                            ? '<c t="n"><v>' + a[c] + "</v></c>"
                            : '<c t="inlineStr"><is><t>' + (!a[c].replace ? a[c] : a[c].replace(/&(?!amp;)/g, "&amp;").replace(/[\x00-\x1F\x7F-\x9F]/g, "")) + "</t></is></c>"
                    );
                }
